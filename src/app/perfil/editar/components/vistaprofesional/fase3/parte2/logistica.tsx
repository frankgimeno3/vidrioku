...
const Logistica: FC<LogisticaProps> = ({ user, cambioComponenteMostrar }) => {
  ...
  const [arrayPosicionesLogisticaProps, setArrayPosicionesLogisticaProps] = useState<string[]>([]);
  const [detallePosicionesLogisticaProps, setDetallePosicionesLogisticaProps] = useState<ExperienciaItem[]>([]);

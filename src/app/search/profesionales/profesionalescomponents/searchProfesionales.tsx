  ...
  return (
    <div className="flex flex-col py-2 px-2 text-gray-500 ">
      ...
      {isFiltroOpen == true &&
        ...
        <div className='flex flex-row justify-end mr-7 ' >
          <button className='flex flex-row bg-white px-4 py-2 rounded-md shadow text-gray-500 text-xs items-center ' onClick={() => toggleFiltroOpen()}>          <svg className='w-5 h-5   mr-2' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 20 20' fill='currentColor' >

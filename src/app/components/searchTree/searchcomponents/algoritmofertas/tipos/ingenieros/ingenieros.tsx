...
const Ingenieros: FC <IngenierosProps>= ({setIsOfertasSelected}) => {
    const [segun, setSegun] = useState("")
   
   
    const mostrarListado = () => {
        return setIsOfertasSelected(true)
    }
    ...
    return (<>
        ...
        {segun == "Educacion" && <Iporeducacion setIsOfertasSelected={setIsOfertasSelected} />}

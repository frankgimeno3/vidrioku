  ...
  return (
    <div className='flex flex-col'>
      <div className="flex flex-row w-full justify-between  bg-gradient-to-b from-zinc-900 to-zinc-600 " style={{ height: '800px' }} >
          ...
          <div className=" w-full flex  h-full ">
            <div className="flex flex-col   flex  text-center justify-center w-full  bg-white text-gray-500  ">
              ...
              <div className='bg-gradient-to-b from-cyan-600 to-zinc-700 h-full px-12 flex flex-col pt-24 pb-12 flex-1'>
                <div className='flex flex-col'>
                  <Image src={user?.profilepicture || "/icons/empresas.png"} alt="" width={200} height={200} className="rounded-full mx-auto my-5 shadow-xl" />
        ...
        <div className='flex flex-col   text-white h-full w-full    text-white text-2xl font-medium'  >
        <h2 className="bg-zinc-800 bg-gray-600 font-bold text-lg py-3 text-center">Saludos, {user?.nombre}</h2>
          <div className='flex flex-col mx-12 h-full pt-4'>
            ...
            <p className='pt-4'> Mis ofertas</p>
            <div className='flex flex-col bg-white rounded-lg shadow shadow-xl mb-3 mt-2 text-center '>
              <div className='shadow shadow-lg border border-gray-100 border-sm m-6  rounded-lg'>
                <p className='text-center font-light text-gray-500 text-lg px-12 pt-6'> Tienes X ofertas publicadas</p>
            ...
            <p className='pt-4'> Solicitudes</p>
            <div className='bg-white rounded-lg shadow shadow-xl mb-3 mt-2 text-center '>
              <div className='shadow shadow-lg border border-gray-100 border-sm m-6  rounded-lg'>
                <p className='text-center font-light text-gray-500 text-lg px-12 pt-6'> Has recibido x solicitudes</p>
                <button
                  className=" bg-white hover:bg-gray-100 shadow-lg border text-gray-500 border-gray-100 rounded px-4 py-2 mb-6 mt-2 text-base font-light "
